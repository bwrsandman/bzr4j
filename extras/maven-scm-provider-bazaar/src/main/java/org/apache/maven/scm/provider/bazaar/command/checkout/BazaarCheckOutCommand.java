 ...
 * @version $Id: BazaarCheckOutCommand.java 756920 2009-03-21 11:35:00Z olamy $
 */
    ...
    implements Command
{
        ...
        throws ScmException
    {
        ...
        {
            revArg = "tag:" + version.getName();
//            throw new ScmException( "This provider can't handle tags." );
            getLogger().info( "Checking out: " + revArg );
        }
        ...
        String[] checkoutCmd = new String[]{BazaarConstants.BRANCH_CMD, BazaarConstants.REVISION_OPTION, revArg,
                url, checkoutDir.getAbsolutePath()};
