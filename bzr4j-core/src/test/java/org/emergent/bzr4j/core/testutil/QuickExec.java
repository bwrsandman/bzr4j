...
import org.emergent.bzr4j.core.cli.BzrCommandFactory;
 ...
 */
public class QuickExec implements BzrCommandFactory<BzrTestHandler> {
  ...
  public void cleanup() throws IOException {
    ...
    IOUtil.deleteRecursively(theDir);
  }
  
  public BzrTestHandler createCommand(String operation) {
    return new BzrTestHandler(getCwd(), operation);
  }
