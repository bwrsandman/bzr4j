...
public final class BazaarVersionInfo
{
    ...
    public static BazaarVersionInfo parse( String versionInfoStr )
    {
        ...
        final BazaarRevision revid =
                BazaarRevision.getRevision( BazaarRevision.Prefix.REVID, lines[0].split( ":" )[1] );
        String date = lines[1].split( ":" )[1];
        String buildDate = lines[2].split( ":" )[1];
        final BazaarRevision revno =
                BazaarRevision.getRevision( BazaarRevision.Prefix.REVNO, lines[3].split( ":" )[1] );
