 ...
 * TODO: review
 */
class XmlBazaarAnnotation implements IBazaarAnnotation {
  ...
  protected XmlBazaarAnnotation(final String[] revsionByLine, final String[] authorByLine,
  ...
  public static IBazaarAnnotation getAnnotationFromXml(String annoatexmlOutput)
    ...
    try {
      ...
      ann = new XmlBazaarAnnotation(parser.getRevisions(), parser.getAuthors(),
