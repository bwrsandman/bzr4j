...
import org.emergent.bzr4j.core.xmloutput.XmlBazaarInfo.CmdLineBranchHistory;
import org.emergent.bzr4j.core.xmloutput.XmlBazaarInfo.CmdLineLocations;
import org.emergent.bzr4j.core.xmloutput.XmlBazaarInfo.CmdLineRelatedBranches;
import org.emergent.bzr4j.core.xmloutput.XmlBazaarInfo.CmdLineRepositoryStats;
import org.emergent.bzr4j.core.xmloutput.XmlBazaarInfo.CmdLineWorkingTreeStats;
...
class XmlInfoParser extends XmlAbstractParser {
  ...
  private XmlBazaarInfo parseInfo() throws XMLStreamException, IOException, ParseException {
    ...
    return new XmlBazaarInfo(layout, formats.toArray(new String[0]), branchFormat,
  ...
  private CmdLineBranchHistory parseBranchHistory() throws XMLStreamException, IOException, ParseException {
    int eventType = parser.next();
