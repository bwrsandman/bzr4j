...
class XmlPluginParser extends XmlAbstractParser {
  ...
  private Set<IBazaarPlugin> plugins;

  public Set<IBazaarPlugin> parse(String xml) throws BazaarException {
    plugins = new HashSet<IBazaarPlugin>();
    try {
      ...
      while (parser.nextTag() == XMLStreamConstants.START_ELEMENT) {
        ...
        plugins.add(new XmlBazaarPlugin(doc != null ? doc.trim() : null,
