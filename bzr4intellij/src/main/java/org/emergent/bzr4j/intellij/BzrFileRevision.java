...
public class BzrFileRevision implements VcsFileRevision {
  ...
  public static BzrFileRevision createBzrFileRevision(Project project, BzrFile file, IBazaarLogMessage message) {
    return new BzrFileRevision(project, file, BzrRevisionNumber.createBzrRevisionNumber(message.getRevision()),
        message.getBranchNick(), message.getDate(), message.getCommiter(), message.getMessage());
  }
