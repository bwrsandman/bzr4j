...
public class BzrAnnotation implements FileAnnotation {
  ...
  private final List<BzrFileRevision> vcsFileRevisions;
  private final BzrFile hgFile;

  public BzrAnnotation(BzrFile hgFile,
      List<BzrAnnotationLine> lines, List<BzrFileRevision> vcsFileRevisions) {
    this.lines = lines;
