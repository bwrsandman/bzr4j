...
public class BzrCommittedChangesProvider implements CommittedChangesProvider<CommittedChangeList, ChangeBrowserSettings>
{
    private final Project m_project;

    public BzrCommittedChangesProvider( @NotNull Project project )
    {
        m_project = project;
    }
            ...
            int maxCount ) throws VcsException
    {
        try
        {
            ...
            IJUtil.createBzrClient().setWorkDir( root );
            List<IBazaarLogMessage> messages = IJUtil.createBzrClient().log( root );
